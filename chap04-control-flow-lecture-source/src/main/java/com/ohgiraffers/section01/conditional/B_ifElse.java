...
public class B_ifElse {
    ...
    *   else 문은 조건식의 결과가 거짓(false)이면 else {} 내부의 코드 실행*/
    ...
    /*Index. 1. 문제
    *  정수 한 개를 입력 받아 그 수가 홀수 이면 " 입력 하신 숫자는 홀수입니다 " 출력하고
    *  홀수가 하니면 "입력하신 숫자는 짝수입니다. " 라고 출력하는 프로그램을 만들어보자.
    *  단 조건과 상관없이 프로그램이 종료 될 때 "프로그램을 종료합니다"라고 출력되도록 해보자. */

    public void testSimpleIfElseStatement(){

        Scanner sc = new Scanner(System.in);
        System.out.print("정수를 하나를 입력해주세요 : ");
        int num = sc.nextInt();
