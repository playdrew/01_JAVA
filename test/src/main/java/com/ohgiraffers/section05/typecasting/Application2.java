...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        *  1-4. 논리형은 강제 형변환 규칙도 제외된다. */
        ...
        /* index. 1-4. 논리는 application 에서 한 자동형변환과 같이 강제 형변환 규칙도 제외된다 -> 하지마라. */
